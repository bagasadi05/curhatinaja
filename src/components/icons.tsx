...
export function ChibiIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M12 2a10 10 0 0 0-10 10c0 5.523 4.477 10 10 10s10-4.477 10-10A10 10 0 0 0 12 2z" fill="white" stroke="none" transform="scale(0.95)" transform-origin="center" />
